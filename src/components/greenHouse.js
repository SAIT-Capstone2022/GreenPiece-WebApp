    ...
    <div className="container p-4 m-2 mb-5 mx-auto mt-3 bg-light rounded shadow-lg" style={{ maxWidth: "600px" }}>
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group py-2">
          ...
          <h6 class="text-center text-success" value={data.prefMaxTemp}></h6>
          <input
            type="range"
            name="prefMaxTemp"
            min={20}
        ...
        <div className="form-group py-2">
          ...
          <h6 class="text-center text-success" value={data.prefMinTemp}></h6>
          <input
            type="range"
            name="prefMinTemp"
            min={10}
        ...
        <div className="form-group py-2">
          ...
          <h6 class="text-center text-success" value={data.prefMaxHumidity}></h6>
          <input
            type="range"
        ...
        <div className="form-group py-2">
          ...
          <h6 class="text-center text-success" value={data.prefMinHumidity}></h6>
          <input
            type="range"
        ...
        <div className="form-group py-2">
          ...
          <h6 class="text-center text-success" value={data.prefMaxMoisture}></h6>
          <input
            type="range"
        ...
        <div className="form-group py-2">
          ...
          <h6 class="text-center text-success" value={data.prefMinMoisture}></h6>
          <input
            type="range"
